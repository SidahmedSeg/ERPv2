...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-white group/calendar p-3 [--cell-size:--spacing(11)]",
      ...
      classNames={{
        ...
        month: cn("flex flex-col w-full gap-2 relative", defaultClassNames.month),
        nav: cn(
          "flex items-center gap-1.5 absolute right-0 top-0 z-10",
        ...
        month_caption: cn(
          "flex items-center h-(--cell-size) w-full mb-2 pr-[calc(2*var(--cell-size)+0.375rem)]",
          defaultClassNames.month_caption
        ),
        dropdowns: cn(
          "flex items-center text-sm font-medium h-(--cell-size) gap-1.5",
        ...
        dropdown: cn(
          "appearance-none cursor-pointer w-full h-full opacity-0 absolute inset-0",
